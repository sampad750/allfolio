...
class Allfolio_Nav_Walker extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        if ($depth == 0) {
            //$output .= '<i class="far fa-chevron-down" aria-hidden="true" data-toggle="dropdown"></i>';
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_output .= ( $args->has_children && 0 === $depth ) ? ' <i class="fa fa-chevron-down" aria-hidden="true" ></i> </a>' : esc_attr( $item->attr_title ) . '&nbsp;</a>';
